...
{
    public partial class Identity_Aniadida : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    propiedadesIdPropiedad = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarritoItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarritoItems_propiedades_propiedadesIdPropiedad",
                        column: x => x.propiedadesIdPropiedad,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarritoItems_propiedadesIdPropiedad",
                table: "CarritoItems",
                column: "propiedadesIdPropiedad");
